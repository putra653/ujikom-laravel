                ...
                <div class="row">
                    <div class="col-md-12 mx-0">
                        @if ($errors->any())
                            ...
                            @endif
                        <form id="msform" action="{{route('store.anggota')}}" method="post" enctype="multipart/form-data">
                            @csrf
                            <!-- progressbar -->
                            <ul id="progressbar">
                                <li class="active" id="account"><strong>Pendaftaran</strong></li>
                                <li id="personal"><strong>Pendataan</strong></li>
                                <li id="payment"><strong>Transaksi</strong></li>
                                <li id="confirm"><strong>Keterangan</strong></li>
                            ...
                            <fieldset>
                                <div class="form-card">
                                    ...
                                    <div class="lg:col-span-2">
                                        <label for="inputAddress" class="text-gray-800 text-sm font-medium inline-block mb-2">Kode</label>
                                        @php
                                                  $kodeAnggota = autonumber('anggota', 'kode_anggota', 3, 'ANG');
                                        @endphp 
                                        <input name="kode_anggota" type="text" class="form-input" id="inputAddress" value="{{$kodeAnggota}}"   readonly>
                                        @error('kode_anggota')
                                    ...
                                    <div class="lg:col-span-2">
                                        ...
                                        <input name="nik" type="number" class="form-input" id="inputAddress" placeholder="Masukkan Nik Anda">
                                        @error('nik')
                                            <div class="invalid-feedback">
                                                {{$message}}
                                            </div>
                                    ...
                                    <div class="lg:col-span-2">
                                        ...
                                        <input name="nama" type="text" class="form-input" id="inputAddress" placeholder="Masukkan Nama Anda">
                                        @error('nama')
                                            <div class="invalid-feedback">
                                                {{$message}}
                                            </div>
                                    ...
                                    <div class="lg:col-span-2">
                                        ...
                                        <input name="alamat" type="text" class="form-input" id="inputAddress" placeholder="Masukkan Alamat Anda">
                                        @error('alamat')
                                            <div class="invalid-feedback">
                                                {{$message}}
                                            </div>
                                    ...
                                    <div class="lg:col-span-2">
                                        ...
                                        <input name="email" type="email" class="form-input" id="inputAddress" placeholder="Masukkan Email Anda">
                                        @error('email')
                                            <div class="invalid-feedback">
                                                {{$message}}
                                            </div>
                                    ...
                                    <div class="lg:col-span-2">
                                        ...
                                        <input name="telepon" type="number" class="form-input" id="inputAddress" placeholder="Masukkan Telepon Anda">
                                        @error('telepon')
                                            <div class="invalid-feedback">
                                                {{$message}}
                                            </div>
                            ...
                            <fieldset>
                                <div class="form-card">
                                    ...
                                    <div class="lg:col-span-2">
                                        ...
                                        @endphp
                                        <input name="kode_simpanan" type="text" class="form-input" id="inputAddress" value="{{$kodeSimpanan}}"   readonly>
                                        @error('kode_simpanan')
                                            <div class="invalid-feedback">
                                                {{$message}}
                                            </div>
                                    ...
                                    <div class="lg:col-span-2">
                                        ...
                                        <input name="tanggal" type="date" class="form-input" id="inputAddress" placeholder="Masukkan Nama Anda">
                                        @error('tanggal')
                                            <div class="invalid-feedback">
                                                {{$message}}
                                            </div>
                            ...
                            <fieldset>
                                <div class="form-card">
                                    ...
                                    <div class="lg:col-span-2">
                                        <label for="inputAddress" class="text-gray-800 text-sm font-medium inline-block mb-2">Transaksi</label>
                                        <select class="form-select" aria-label="Default select example" name="transaksi">
                                            <option selected disabled hidden>Pilih Transaksi</option>
                            ...
                            <fieldset>
                                ...
                                <input type="button" name="previous" class="previous action-button-previous" value="Previous"/>
                                <input type="submit" name="make_payment" class="next action-button" value="Sumbit"/>
                            </fieldset>
                        </form>
                    </div>
                </div>
